...
const navigation = [
  { name: "Dashboard", onClick: "#", current: true },
  { name: "Team", onClick: "#", current: false },
  { name: "Projects", onClick: "#", current: false },
  { name: "Calendar", onClick: "#", current: false },
  { name: "Reports", onClick: "#", current: false },
];
